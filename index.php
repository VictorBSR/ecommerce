...
$app->get("/checkout", function() {
	...
	if(!$address->getdezipcode()) $address->setdeszicode('');
...
$app->post("/checkout", function() {
	...
	if(!isset($_POST['zipcode']) || $_POST['zipcode'] === '') {
		Address::setMsgError("Infomre o CEP.");
		header('Location: /checkout');
		exit;
	}
	
	if(!isset($_POST['desaddress']) || $_POST['desaddress'] === '') {
		Address::setMsgError("Infomre o endereço.");
		header('Location: /checkout');
		exit;
	}

	if(!isset($_POST['desdistrict']) || $_POST['desdistrict'] === '') {
		Address::setMsgError("Infomre o bairro.");
		header('Location: /checkout');
		exit;
	}

	if(!isset($_POST['descity']) || $_POST['descity'] === '') {
		Address::setMsgError("Infomre a cidade.");
		header('Location: /checkout');
		exit;
	}

	if(!isset($_POST['desstate']) || $_POST['desstate'] === '') {
		Address::setMsgError("Infomre o estado.");
		header('Location: /checkout');
		exit;
	}

	if(!isset($_POST['descountry']) || $_POST['descountry'] === '') {
		Address::setMsgError("Infomre o país.");
		header('Location: /checkout');
		exit;
	}
...
$app->get("/boleto/:idorder", function($order){
